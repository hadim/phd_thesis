...
Il est d'ailleurs très intéressant de remarquer que dans les MSD avec
TBZ, la troisième pente (de 2s à 40s) est quasiment égale à la seconde
pente (de 0.3s à 2s). Cela pourrait signifier que les kinétochores en
présence de TBZ sont peu soumis à une force possiblement dirigée par un
processus de mouvement dirigé comme le confirme l'analyse des
oscillations en Section~\ref{sec:article}.

...
Cette régulation spatiale implique que au moins des processus régulant
...
processus cellulaires clés tel que la division cellulaire. En effet, il
a été montré que les kinésines dépolymérisatrice contrairement aux
autres kinésines sont présentes dans toutes les cellules eucaryotes
testées jusqu'à présent (Wickstead and Gull,
\hyperref[ref-Wickstead2006]{2006}). Ceci montre bien que les kinésines
outre leurs rôles dans le transport des vésicules et des organites ont
une activité propre qui est l'origine de la régulation de mécanismes
aussi complexe que la dynamique des microtubules. L'évolution a
sélectionné un outil très puissant car capable de moduler de manière

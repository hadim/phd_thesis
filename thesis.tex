...
de Cheeseman and Desai (\hyperref[ref-Cheeseman2008]{2008})). Durant les
cinq phases de la mitose la cellule établit un fuseau mitotique par
élongation de ces deux pôles (en vert) puis doit répartir la même
quantité de chromosomes (en bleu) à chacun des pôles.}
\end{figure}
...
\caption{\label{fig:ndc80}Stucture de l'attachement

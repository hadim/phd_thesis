...
\caption[Schéma du cycle cellulaire de \_S. pombe\_]{\label{fig:pombe-cell-cycle}Schéma
du cycle cellulaire de \emph{S. pombe}. La levure à fission possède une
phase G2 très longue comparé à d'autres types cellulaire.}
\end{figure}
...
\caption[Trajectoire des chromosomes \_\_in silico\_\_]{\label{fig:traj_model}Une
...
utilise les différents coeurs de la machine pour exécuter plusieurs
simulations en même temps. Donc une machine possédant deux coeurs
exécute en théorie les quatres simulations deux fois plus vite qu'un
algorithme non parallélisé (en rose).}
\end{figure}
...
\caption[GUI]{\label{fig:kt-simul-gui}Animation graphique d'une

...
\caption{\label{fig:virchow}Illustration du livre « Cell theory » de
Rudolf Virchow (Virchow, \hyperref[ref-virchow1860cellular]{1860})}
\end{figure}
...
de Cheeseman and Desai (\hyperref[ref-Cheeseman2008]{2008}))}
\end{figure}
...
\caption{\label{fig:kt}\textbf{A.} Vue d'un kinétochore humain de côté
par microscopie électronique (McEwen et al.
...
\caption{\label{fig:mt}\textbf{A.} Schéma présentant l'organisation d'un
microtubule. \textbf{B.} Les microtubules sont des structures hautement
dynamiques qui passent très souvent d'un état à un autre (Walczak et
al., \hyperref[ref-Walczak2010]{2010}).}
\end{figure}
...
\caption{\label{fig:dep_kinesin}Vue 3D de la kinésine-13 (MCAK) et de la
kinésine-8 (Kif18a) chez des cellules humaines. La troisième vue montre
une superposition des deux protéines. (Walczak et al.,
...
\caption{\label{fig:ndc80}\textbf{A.} Vue schématique de la structure du
...
en vert et rouge. (Huang et al., \hyperref[ref-Huang2008]{2008}; Wan et
al., \hyperref[ref-Wan2012]{2012})}
\end{figure}
...
(Paul et al., \hyperref[ref-Paul2009]{2009}). \textbf{A}. Des
...
\caption{\label{fig:hill_model}Différents types d'attachement entre le
microtubule et le kinétochore (Civelekoglu-Scholey and Cimini,
...
\caption{\label{fig:pombe}\textbf{A}. Vue en microscopie électronique à
...
\caption{\label{fig:pombe-cell-cycle}Schéma du cycle cellulaire de
\emph{S. pombe}.}
\end{figure}
...
\caption{\label{fig:lac}\textbf{A}. Système LacO/LacI pour la
...
fondamentales : la masse, l'amortisseur et le ressort (adapté de Howard
(\hyperref[ref-Howard2001]{2001})). Les ordres de grandeurs
...
\caption{\label{fig:parallel}Différence de vitesse d'exécution théorique
entre une implémentation parallélisée et une implémentation séquentiel.
Un algorithme parallélisé (en bleu) utilise les différents coeurs de la
machine pour exécuter plusieurs simulations en même temps. Donc une
machine possédant deux coeurs exécute en théorie les quatres simulations
deux fois plus vite qu'un algorithme non parallélisé (en rose).}
\end{figure}
...
\caption{\label{fig:ch_alignment}Distribution de l'alignement relatif
...
\caption{\label{fig:three_states}TODO}
\end{figure}

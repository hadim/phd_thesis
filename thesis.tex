...
\makesomeone{judge}{4}{Emmanuelle Fabre}{Directeur de recherche}{Membre du Jury}
...
\caption[fig:]{\label{fig:virchow}Illustration du livre « Cell theory »
de Rudolf Virchow (Virchow, \hyperref[ref-virchow1860cellular]{1860})}
\end{figure}
...
\caption[fig:]{\label{fig:cycle}Les différentes étapes du cycle
cellulaire. Les phases S et G2 préparent la division cellulaire qui a
lieu à la phase M.}
\end{figure}
...
\caption[fig:]{\label{fig:mitosis}Les différentes étapes de la mitose
(adapté de Cheeseman and Desai (\hyperref[ref-Cheeseman2008]{2008})).
...
\caption[fig:]{\label{fig:kt}Structure d'un kinétochore. \textbf{A.} Vue
d'un kinétochore humain de côté par microscopie électronique (McEwen et
al. (\hyperref[ref-McEwen2007]{2007})). \textbf{B.} Schéma des
...
\caption[fig:]{\label{fig:mt}Structure et dynamique du microtubule.
...
\caption[fig:]{\label{fig:dep_kinesin}Vue en trois dimensions de la
...
(Walczak et al., \hyperref[ref-Walczak2013a]{2013})}
\end{figure}
...
\caption[fig:]{\label{fig:ndc80}Stucture de l'attachement
kinétochore-microtubule. \textbf{A.} Vue schématique de la structure du
complexe NDC80 ainsi que sa localisation dans le kinétochore.
\textbf{B.} Interaction non contrainte entre des complexes NDC80 (en
rouge) avec différents microtubules (en vert) (Zaytsev et al.,
...
\caption[fig:]{\label{fig:attachements}Les différents types
d'attachements des microtubules aux kinétochores. Le seul attachement
correct pour le fuseau mitotique est l'attachement amphitélique aussi
appelé attachement bi-orienté. Les autres attachements sont généralement
corrigés durant la mitose.}
\end{figure}
...
\caption[fig:]{\label{fig:aurora}Le mécanisme de déstabilisation de
l'attachement KT-MT. Quand les deux kinétochores sœurs sont éloignés
...
\caption[fig:]{\label{fig:spindle_micro}Deux cellules en métaphase
(cellule HeLa à gauche et cellule Ptk1 à droite). Pour les deux cellules
les kinétochores de l'ensemble des chromosomes sont marqués
respectivement en rouge et vert tandis que les microtubules sont marqués
respectivement en vert et rouge. (Huang et al.,
...
\caption[fig:]{\label{fig:congression}Cellule humaine (RPE1) en début de
...
\item
  ...
  \tightlist
  \item
    un attachement qui produit de la force (NDC80 qui track le MT
    depoly) comme proposé in vitro par (Joglekar and DeLuca,
    \hyperref[ref-Joglekar2009]{2009}; Powers et al.,
    \hyperref[ref-Powers2009a]{2009}) : continuité du modele de Hill
    (Hill, \hyperref[ref-Hill1985]{1985})
  \item
    une regulation au niveau des deux kinétochores freres pr savoir qui
    tire ou pas (these de harry)
  \end{itemize}
\item
  (Wan et al., \hyperref[ref-Wan2012]{2012}) pour l'intro avec skibbens
\item
  switch entre irregular movement et oscillations (Magidson et al.,
  \hyperref[ref-Magidson2011]{2011})
\item
  mouvement AP et P
\item
  these de harry qui prend pas en compte les mvt irreguliers (Harry,
  \hyperref[ref-Harry2014]{2014})
\item
...
\caption[fig:]{\label{fig:spindle}Schéma d'un fuseau mitotique en
métaphase (mitose fermé). Les flèches correspondent aux forces
appliquées sur les différents éléments du fuseau mitotique.}
\end{figure}
...
direction du pôle vers lequel elle est attachée, c'est l'anaphase (TODO:
go deeper).
...
\caption[fig:]{\label{fig:sac}Le mécanisme d'action du SAC. Les
chromosomes non-attachés catalysent la formation du MCC au niveau du
kinétochore. Le MCC bloque l'activité de l'ubiquitine ligase APC/C. Une
fois tous les kinétochores correctement attachés, l'APC/C dégrade la
sécurine, ce qui active la séparase qui clive le complexe protéique de
la cohésine.}
\end{figure}
...
\caption[fig:]{\label{fig:mogilner}Modèle numérique de l'assemblage du
fuseau (Paul et al., \hyperref[ref-Paul2009]{2009}). \textbf{A}. Des
...
\caption[fig:]{\label{fig:assembly_time}Temps moyen de capture de tous
les chromosomes en fonction du nombre de chromosomes total pour trois
...
et al., \hyperref[ref-Wollman2005]{2005}).}
\end{figure}
...
\caption[fig:]{\label{fig:spindle_assembly}Deux mécanismes expliquant la
fidélité des attachements durant le processus de « recherche et capture
». \textbf{A}. Mécanisme impliquant l'orientation du kinétochore frère
en réponse à un attachement monotélique. \textbf{B}. Mécanisme évolutif
qui « sélectionne » l'attachement amphitélique (box couleur saumon) avec
le temps en explorant différents états d'attachement.}
\end{figure}
...
\caption[fig:]{\label{fig:hill_model}Différents modèles de types
d'attachement entre le microtubule et le kinétochore
...
\caption[fig:]{\label{fig:gay}Modèle de ségrégation des chromosomes basé
sur un attachement KT-MT stochastique (Gay et al.,
\hyperref[ref-Gay2012a]{2012}). \textbf{A}. Schéma du fuseau mitotique
de la levure à fission. \textbf{B}. Schéma du modèle représentant la
façon dont sont agencés les différents éléments mécaniques du modèle
reproduisant un fuseau mitotique \emph{in vivo}.}
\end{figure}
...
\caption[fig:]{\label{fig:pombe}Morphologie de la levure à fission.
\textbf{A}. Vue en microscopie électronique à balayage de \emph{S.
pombe} (Morgan, \hyperref[ref-Morgan2007]{2007}). \textbf{B}. Vue en
microscopie optique à champ large en fond clair. La barre correspond à 8
μm dans les deux vues.}
\end{figure}
...
\caption[fig:]{\label{fig:pombe-cell-cycle}Schéma du cycle cellulaire de
\emph{S. pombe}. La levure à fission possède une phase G2 très longue
...
\caption[fig:]{\label{fig:lac}Visualisation d'un seul chromosome en
...
\tightlist
\item
  parler de la détection par deflation (implementation trop lente?, pk
  ca marche pas pr nous?)
\item
  parler de l'algo de jaquaman et de scikit tracker : pk ca marche pas
  ici aussi? du a détection trop mauvaise et pas à l'algo de tracking
\end{itemize}

\subsection{Traitement des trajectoires par des techniques d'analyse du
signal}\label{traitement-des-trajectoires-par-des-techniques-danalyse-du-signal}

\begin{itemize}
\tightlist
\item
  parler des techniques utilisées dans le papier et des problemes qu on
  a eu
\item
  dam1
\end{itemize}

\subsection{Cohérence kinetochore
AP-P}\label{cohuxe9rence-kinetochore-ap-p}
...
(TODO: EST CE QUE JE DOIS PAS FOUTRE CETTE PARTIE EN INTRO PLUTOT ? EN
MEME TEMPS JE FAIS UNE CONNECTION DIRECT AVEC LES MODIFS FAITE DURANT MA
THESE SUR LE MODELE DONC JE TROUVE BIEN AUSSI DE LE LAISSER EN
RESULTAT\ldots{} VOUS EN PENSEZ QUOI ?)
...
\item
  ...
  opposée à la force centrifuge qui empèche un objet en rotation de «
  fuir » le centre.
\item
  ...
  moléculare absorbe \(10^9\) photons par seconde (cela correspond à un
...
mesurer à des échelles microscopiques les rend diffcilement utilisable
...
\(v = F/\gamma\), où γ correspont au coefficient de viscosité
...
une force. L'allongement d'un élastique par rapport à sa longeur de
...
\begin{figure}[htbp]
\centering
\includegraphics{figures/results/force_types.png}
\caption[fig:]{\label{fig:force_types}Schéma des trois éléments
mécaniques fondamentales : la masse, l'amortisseur et le ressort (adapté
de Howard (\hyperref[ref-Howard2001]{2001})). Les ordres de grandeurs
...
\begin{figure}[htbp]
\centering
\includegraphics{figures/results/motion_equation.png}
\caption[fig:]{\label{fig:motion_equation}L'équation du mouvement décrit
l'évolution spatial d'un objet au cours du temps sous l'action de
plusieurs forces appliquées sur lui. Le terme inertiel peut être omis
dans le cas d'un objet évoluant dans un système très visqueux pour des
nombres de Reynolds très bas.}
\end{figure}
...
terme inertiel lorsqu'on étudie des sytèmes où la force inertiel est
...
\begin{figure}[htbp]
\centering
\includegraphics{figures/results/spindle_model.png}
\caption[fig:]{\label{fig:spindle_model}Le fuseau modélisé est composé
de différents objets ayant des propriétés visco-élastique définies. On
...
\begin{figure}[htbp]
\centering
\includegraphics{figures/results/traj_model.png}
\caption[fig:]{\label{fig:traj_model}Une simulation numérique permet de
résoudre l'équation du mouvement et ensuite accéder à l'évolution des
positions de chaque objets au cours du temps.}
\end{figure}
...
disponible en libre accès sous license open-source à cette adresse :
\texttt{https://github.com/bnoi/kt\_simul}. Le code source est basé sur
le language de programmation Python ainsi que l'ensemble des librairies
...
coeurs de la machine qui les exécute. La parallélisation permet une
...
de travail classique, équipé de 16 coeurs Intel Xeon E5-2650 cadencé à
2GHz, est capable d'exécuter plus de 2000 simulations standards tandis
que la version non parallélisée en exécute seulement 200.

\begin{figure}[htbp]
\centering
\includegraphics{figures/results/parallel.png}
\caption[fig:]{\label{fig:parallel}Schéma décrivant le principe de la
...
séquentiel. Un algorithme parallélisé (en bleu) utilise les différents
coeurs de la machine pour exécuter plusieurs simulations en même temps.
Donc une machine possédant deux coeurs exécute en théorie les quatres
...
d'alignement \emph{in vivo} (pour le détail de l'implementation, se
référer aux méthodes de l'article en Section~\ref{sec:article}).

\begin{figure}[htbp]
\centering
\includegraphics{figures/results/hyp1.png}
\caption[fig:]{\label{fig:hyp1}Schémas et exemple de trajectoire
\emph{in silico} du mécanisme d'alignement avec et sans force dépendante
de la longueur.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{figures/results/ch_alignment.png}
\caption[fig:]{\label{fig:ch_alignment}Distribution de l'alignement
relatif des chromosomes en anaphase \emph{in vivo} (dans les cellules
WT, n=52 et klp6Δ, n=63) et \emph{in silico} pour l'hypothèse 1 (avec,
n=60 ou sans la force dépendante de la longueur, n=60) et \emph{in
silico} pour l'hypothèse 2 (avec, n=60 ou sans la force dépendante de la
longueur, n=60). Une distance proche de 0 signifie que le chromosome est
positionnée au milieu du fuseau mitotique.}
\end{figure}

L'hypothèse 1, présenté dans l'article (Section~\ref{sec:article}), est
princpalement basé sur des observations \emph{in vivo} et \emph{in
...
manière fidéle l'alignement ainsi que les chromosomes retardataires en
...
largement hypothètique.

La flexibilité de l'implementation du modèle \texttt{kt\_simul} permet
...
(voir nottament la Figure 12 de Ding et al.
...
d'attachement des microtubules aux kinétochores. Dans le modèle intial
...
\emph{in vivo} en faisant coincider la distribution de
...
Cependant il est possible de supposer une distribtuion hypothétique
...
\begin{figure}[htbp]
\centering
\includegraphics{figures/results/hyp2.png}
\caption[fig:]{\label{fig:hyp2}Schémas et exemple de trajectoire
\emph{in silico} du mécanisme d'alignement avec et sans taux
d'attachement dépendant de la longueur.}
\end{figure}
...
produirent ce type de mouvement coordonné (Wan et al.,
\hyperref[ref-Wan2012]{2012}).

On rappelle que le modèle initialement développé (Gay et al.,
\hyperref[ref-Gay2012a]{2012}) ne contient pas de structure pouvant
s'apparenter aux microtubules \emph{in vivo}. En effet, chaque site
d'attachement peut se trouver dans deux états; soit « ON » est produire
une force en direction du pôle, soit « OFF » est ne produire aucune
force (Figure~\ref{fig:two_states}). Le passage entre les deux états se
fait de manière stochastique avec en plus deux mécanismes de corrections
qui peuvent modifier les constantes d'attachement et de détachement
(voir Gay et al. (\hyperref[ref-Gay2012a]{2012}) pour le fonctionnement
de ces deux mécanismes de corrections).

\begin{figure}[htbp]
\centering
\includegraphics{figures/results/two_states.png}
\caption[fig:]{\label{fig:two_states}Modèle d'attachement à deux états.
Le passage d'un état à l'autre se fait de manière stochastique et est
...
flexibilité dans la dynamique des attachements et donc aussi dans la
dynamique des forces appliquées aux chromosomes.

\begin{figure}[htbp]
\centering
\includegraphics{figures/results/three_states.png}
\caption[fig:]{\label{fig:three_states}TODO}
\end{figure}

\chapter{Discussion}\label{discussion}

\section{Le mouvement des chromosomes durant la
mitose}\label{le-mouvement-des-chromosomes-durant-la-mitose}
...
\section{Modéliser la mitose : jusqu'à quelle précision
?}\label{moduxe9liser-la-mitose-jusquuxe0-quelle-pruxe9cision}

\section{démarche méthode scientifique / bio quantitative et
computationnelle}\label{duxe9marche-muxe9thode-scientifique-bio-quantitative-et-computationnelle}

\section{dynamique des chromosomes}\label{dynamique-des-chromosomes}
...
\caption[fig:]{\label{fig:kt-simul-traj}Exemple de trajectoire générée
par \texttt{kt\_simul}. En plus de l'évolution de la position (axe des
...
\caption[fig:]{\label{fig:kt-simul-gui}Animation graphique d'une
simulation. L'interface graphique permet de suivre la dynamique en temps
réel à l'aide d'un « slider » en bas qui permet de changer le temps. Le
panneau à droite permet d'avoir une vue détaillée de la position et de
...
\hyperdef{}{ref-Harry2014}{\label{ref-Harry2014}}
Harry, E. (2014). Metaphase chromosome dynamics investigated by high
resolution tracking and data-driven modelling.
...
\hyperdef{}{ref-Magidson2011}{\label{ref-Magidson2011}}
Magidson, V., O'Connell, C.B., Lončarek, J., Paul, R., Mogilner, A., and
Khodjakov, A. (2011). The spatial arrangement of chromosomes during
prometaphase facilitates spindle assembly. Cell \emph{146}, 555--567.
...
position is regulated by tension. Journal of Cell Science \emph{108 ( Pt
7}, 2537--2548.

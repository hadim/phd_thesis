...
![Distance inter-kinétochore en fonction de l'état de cohérence dans différentes conditions. Les commentaires de la figure précédente s'appliquent à cette figure.](figures/results/imaging/coherence_stretch.png "Distance inter-kinétochore en fonction de l'état de cohérence dans différentes conditions"){#fig:coherence_stretch}

...
![Une simulation numérique permet de résoudre l'équation du mouvement et ensuite accéder à l'évolution des positions de chaque objets au cours du temps.](figures/results/traj_model.png "Trajectoire des chromosomes __in silico__"){#fig:traj_model}

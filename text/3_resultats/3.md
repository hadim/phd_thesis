...
TODO: LA GUILLAUME SI T'AS DES IDÉES PR RAJOUTER DES TRUCS, N'HESITE PAS. EN MEME TEMPS ON A EU PEU DE RESULTATS AVEC CA DC BON... APRES JE RESTE CONVAINCU QUE CETTE STRATEGIE EN Y PASSANT UN PEU DE TEMPS PEU DONNER DES TRUCS SYMPA SANS AVOIR A SORTIR L'ARTILLERIE LOURDE EN MODELISANT LES MICROTUBULES COMPLETEMENT.
...
L'idée du modèle d'attachement à trois états est d'ajouter une niveau de flexibilité dans la dynamique des attachements et donc aussi dans la dynamique des forces appliquées aux chromosomes.

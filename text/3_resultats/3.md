...
La modélisation _in silico_ des trajectoires des chromosomes en mitose permet de mieux comprendre quel sont les mécanismes sous-jacent responsables de la régulation de ces mouvements. L'approche « modèles de connaissance », qui s'inspire de la mécanique du point, est utilisé et permet d'établir des hypothèses sur les mécanismes de congression des chromosomes en métaphase. Enfin d'autre hypothèses sont aussi envisagées afin de décrire les oscillations du mouvement des chromosomes observées _in vivo_.

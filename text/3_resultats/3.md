...
![Distribution de l'alignement relatif des chromosomes en anaphase _in vivo_ (dans les cellules WT, n=52 et klp6Δ, n=63) et _in silico_ pour l'hypothèse 1 (avec, n=600 ou sans la force dépendante de la longueur, n=600) et _in silico_ pour l'hypothèse 2 (avec, n=600 ou sans la force dépendante de la longueur, n=600). Une distance proche de 0 signifie que le chromosome est positionnée au milieu du fuseau mitotique.](figures/results/ch_alignment.png){#fig:ch_alignment}

...
![Modèle d'attachement à deux états. Le passage d'un état à l'autre se fait de manière stochastique et est régulé par deux mécanismes de corrections gouvernés par les deux paramètres $\beta$ et $d_\alpha$ [@Gay2012a].](figures/results/two_states.png){#fig:two_states}
...
![TODO](figures/results/three_states.png){#fig:three_states}

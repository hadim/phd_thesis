...
Cette équation différentielle peut ensuite être résolu afin de déterminer la vitesse et donc la position de chaque objet dans le temps (@fig:spindle_model).

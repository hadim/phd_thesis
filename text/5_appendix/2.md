...
Pour chaque jeu de paramètre cinq simulations sont exécutes. Enfin la durée des simulations est fixée à 3000s (50min).

Bien que quelques simulations exhibent des mouvements periodiques, aucun des jeux de paramètre associés n'a été capable de reproduire de manière significative un signal régulier. La figure @fig:simu-oscill-all montre quelques exemples de trajectoires simulées avec leurs autocorrélations et transformées de Fourier associées.
